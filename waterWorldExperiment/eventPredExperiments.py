...
if __name__ == "__main__":
    ...
    accuracy_results_1 = vary_no_of_succ_traces(no_of_runs, num_succ_traces_arr, num_episodes)

    num_episodes_arr = np.arange(100, 600, 100)
    num_succ_traces = 50
    accuracy_results_1 = vary_no_of_episodes(no_of_runs, num_episodes_arr, num_succ_traces)
