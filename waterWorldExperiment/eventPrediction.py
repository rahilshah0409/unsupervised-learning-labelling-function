...
if __name__ == '__main__':
    ...
    shortest_ep_durations, relevant_state_seqs, relevant_events = extract_shortest_succ_traces(
    ...
    relevant_state_seqs = list(map(lambda seq: list(
        map(lambda state: state.detach().numpy(), seq)), relevant_state_seqs))
    ...
    correct_labels = [l1 for l1, l2 in zip(
        event_labels, conc_relevant_events) if l1 == l2]
